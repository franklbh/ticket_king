...
export const vrExperiences = [
  ...
  },
  {
    ...
    offPeakPrices: { adult: 25.95, senior: 24.95, child: 21.95, family: 22.95, group: 23.95 },
    peakPrices:    { adult: 27.95, senior: 26.95, child: 23.95, family: 24.95, group: 25.95 },
    accent: '#22c55e',
...
export const arcadeGames = [
  {
    ...
    offPeakPrices: { adult: 15.95, child: 12.95, family: 13.95, group: 14.95 },
    peakPrices:    { adult: 16.95, child: 13.95, family: 14.95, group: 15.95 },
    accent: '#8b5cf6',
