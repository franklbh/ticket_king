...
export const translations = {
  en: {
    ...
    pandaTitle: "Panda's World", pandaSub: "A Giant's World", pandaTagline: "See life through a giant panda's eyes",
    dragonTitle: 'Back to the Jurassic', dragonSub: 'Rise of the Ancient', dragonTagline: 'Soar through mythical skies on dragonback',
  ...
  'zh-Hans': {
    ...
    pandaTitle: "Panda's World", pandaSub: '巨兽的世界', pandaTagline: '透过大熊猫的眼睛看世界',
    dragonTitle: 'Back to the Jurassic', dragonSub: '上古之觉醒', dragonTagline: '骑乘神龙，翱翔神话天空',
  ...
  'zh-Hant': {
    ...
    pandaTitle: "Panda's World", pandaSub: '巨獸的世界', pandaTagline: '透過大熊貓的眼睛看世界',
    dragonTitle: 'Back to the Jurassic', dragonSub: '上古之覺醒', dragonTagline: '騎乘神龍，翱翔神話天空',
