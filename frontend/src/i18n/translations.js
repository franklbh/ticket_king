...
export const translations = {
  en: {
    ...
    cyberTitle: 'Cyber Arena', cyberSub: 'Neon Battlegrounds', cyberTagline: 'Fight for glory in the neon-lit arena',
    spaceTitle: 'Space Odyssey', spaceSub: 'Beyond the Milky Way', spaceTagline: 'Float through the cosmos in zero gravity',
    oceanTitle: 'Ocean Quest', oceanSub: 'Secrets of the Deep', oceanTagline: 'Dive into a world beneath the waves',
    ...
    vrGamesSubhead: 'Competitive multiplayer fun — battle friends, explore space, dive into the deep. Pick up and play in minutes.',
  ...
  'zh-Hans': {
    ...
    cyberTitle: '霓虹竞技场', cyberSub: '荧光战场', cyberTagline: '在霓虹竞技场争夺荣耀',
    spaceTitle: '太空漫游', spaceSub: '超越银河', spaceTagline: '在零重力中漫游宇宙',
    oceanTitle: '深海探秘', oceanSub: '海洋深处的秘密', oceanTagline: '潜入海浪之下的神秘世界',
    ...
    vrGamesSubhead: '多人竞技娱乐 — 与朋友对战、探索太空、深入海底，几分钟上手。',
  ...
  'zh-Hant': {
    ...
    cyberTitle: '霓虹競技場', cyberSub: '螢光戰場', cyberTagline: '在霓虹競技場爭奪榮耀',
    spaceTitle: '太空漫遊', spaceSub: '超越銀河', spaceTagline: '在零重力中漫遊宇宙',
    oceanTitle: '深海探秘', oceanSub: '海洋深處的秘密', oceanTagline: '潛入海浪之下的神秘世界',
    ...
    vrGamesSubhead: '多人競技娛樂 — 與朋友對戰、探索太空、深入海底，幾分鐘上手。',
