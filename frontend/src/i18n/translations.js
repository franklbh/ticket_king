...
export const translations = {
  en: {
    ...
    totalAmount: 'Total Amount', firstName: 'First name', lastName: 'Last name', email: 'Email', phoneOptional: 'Phone',
    ...
    phoneError: 'Enter a valid phone number with 10 to 15 digits.',
  ...
  'zh-Hans': {
    ...
    totalAmount: '总金额', firstName: '名字', lastName: '姓氏', email: '邮箱', phoneOptional: '电话',
    ...
    phoneError: '请输入 10 到 15 位数字的有效电话号码。',
  ...
  'zh-Hant': {
    ...
    totalAmount: '總金額', firstName: '名字', lastName: '姓氏', email: '電郵', phoneOptional: '電話',
    ...
    phoneError: '請輸入 10 到 15 位數字的有效電話號碼。',
