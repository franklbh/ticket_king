...
with matrix(event_slug, ticket_name, lower_days, lower_start, lower_end, lower_price, higher_days, higher_start, higher_end, higher_price) as (
  values
    ...
    ('panda-vr', 'Senior (65+)', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 24.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 26.95),
    ...
    ('dino-vr', 'Senior (65+)', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 24.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 26.95),
