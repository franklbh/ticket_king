...
with matrix(event_slug, ticket_name, lower_days, lower_start, lower_end, lower_price, higher_days, higher_start, higher_end, higher_price) as (
  values
    ('terracotta-warriors', 'Adult', array['Mon','Tue','Wed','Thu','Fri']::text[], time '10:00', time '14:30', 37.95, array['Sat','Sun']::text[], time '10:00', time '14:30', 45.95),
    ('terracotta-warriors', 'Child (7-15)', array['Mon','Tue','Wed','Thu','Fri']::text[], time '10:00', time '14:30', 27.95, array['Sat','Sun']::text[], time '10:00', time '14:30', 34.95),
    ('terracotta-warriors', 'Senior (65+)', array['Mon','Tue','Wed','Thu','Fri']::text[], time '10:00', time '14:30', 34.95, array['Sat','Sun']::text[], time '10:00', time '14:30', 41.95),
    ('terracotta-warriors', 'Group (6+ people)', array['Mon','Tue','Wed','Thu','Fri']::text[], time '10:00', time '14:30', 32.95, array['Sat','Sun']::text[], time '10:00', time '14:30', 40.95),
    ('terracotta-warriors', 'Family (2 adults + 1 child)', array['Mon','Tue','Wed','Thu','Fri']::text[], time '10:00', time '14:30', 31.95, array['Sat','Sun']::text[], time '10:00', time '14:30', 39.95),

    ('panda-vr', 'Adult', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 25.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 27.95),
    ('panda-vr', 'Child/Youth (7-15)', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 21.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 23.95),
    ('panda-vr', 'Group (6+ people)', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 23.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 25.95),
    ('panda-vr', 'Family (2 adults + 1 child)', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 22.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 24.95),

    ('dino-vr', 'Adult', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 25.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 27.95),
    ('dino-vr', 'Child/Youth (7-15)', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 21.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 23.95),
    ('dino-vr', 'Group (6+ people)', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 23.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 25.95),
    ('dino-vr', 'Family (2 adults + 1 child)', array['Sun','Mon','Tue','Wed','Thu']::text[], time '15:00', time '19:00', 22.95, array['Fri','Sat']::text[], time '15:00', time '20:00', 24.95),
